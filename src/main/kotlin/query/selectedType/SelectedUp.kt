...
class SelectedUp(private val update: Update, private val bot: FeatEatBot) {
    fun calcAndShow() {
        if (update.hasCallbackQuery() && (update.callbackQuery.data == "up")) {
            ...
            message.text = "Белка 30% = от $proteinsBottomLine до $proteinsUpperLine ккал = \n" +
            ...
            message.text = "Жиров 25% = от $fatsBottomLine до $fatsUpperLine ккал = \n" +
            ...
            message.text = "Углеводов 45% = от $carbohydratesBottomLine до $carbohydratesUpperLine ккал = \n" +
